...
function App() {
  ...
  const [loading, setLoading] = useState(
    !cachedUser && !!localStorage.getItem("token"),
  );
        ...
        <BrowserRouter>
          <Routes>
            <Route
              path="/auth"
              element={
                !user ? <AuthPage setUser={setUser} /> : <Navigate to="/feed" />
              }
            />
            ...
            <Route
              path="/messages"
              element={
                user ? <MessagesPage user={user} /> : <Navigate to="/auth" />
              }
            />
            <Route
            ...
            <Route
              path="/search"
              element={
                user ? <SearchPage user={user} /> : <Navigate to="/auth" />
              }
            />
            ...
            <Route
              ...
              element={
                user ? (
                  ...
                  <MirrorRedirect kind="post" param="postId" />
                )
              }
            />
            ...
            <Route
              ...
              element={
                user ? (
                  <SavedPage user={user} setUser={setUser} />
                ) : (
                  <Navigate to="/auth" />
                )
              }
            ...
            <Route
              ...
              element={
                user ? (
                  <AdminMetrics user={user} setUser={setUser} />
                ) : (
                  <Navigate to="/auth" />
                )
              }
            ...
            <Route
              ...
              element={
                user ? (
                  <PrivacyCenter user={user} setUser={setUser} />
                ) : (
                  <Navigate to="/auth" />
                )
              }
            ...
            <Route
              ...
              element={
                user ? (
                  <ClipsSearchPage user={user} setUser={setUser} />
                ) : (
                  <Navigate to="/auth" />
                )
              }
            ...
            <Route
              ...
              element={
                user ? (
                  <ClipsPage user={user} setUser={setUser} />
                ) : (
                  <Navigate to="/auth" />
                )
              }
            ...
            <Route
              ...
              element={
                user ? (
                  ...
                  <MirrorRedirect kind="clip" param="clipId" />
                )
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                user ? (
                  <LiveStream user={user} setUser={setUser} />
                ) : (
                  <Navigate to="/auth" />
                )
              }
