...
function accentColor() {
  try {
    ...
    return (
      (
        s.getPropertyValue("--nexus-accent-solid") ||
        s.getPropertyValue("--nexus-accent") ||
        ""
      ).trim() || "#22d3ee"
    );
  } catch {
...
export default function DrawCanvasModal({ open, onClose, onSubmit }) {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(2,6,20,0.92)" }}
    >
