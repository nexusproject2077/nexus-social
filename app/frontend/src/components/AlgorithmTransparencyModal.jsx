  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-xs leading-relaxed" style={{ color: "#bbc9cd" }}>
          {children}
        </div>
      </div>
    </div>
      ...
      >
        ...
        <div className="p-5 space-y-5 overflow-y-auto">
          <p className="text-xs leading-relaxed" style={{ color: "#859397" }}>
            Conformément au Digital Services Act (règlement européen sur les
            services numériques), voici les principaux paramètres qui
            déterminent les contenus que vous voyez sur Nexus, et comment les
            modifier.
          </p>
          ...
          <Section icon={Sparkles} title="Fil « Pour toi »">
            <p className="mb-3">
              Ce fil classe les publications selon plusieurs facteurs. Voici
              leur poids relatif approximatif :
            </p>
                ...
                <div key={f.label}>
                  ...
                  >
                    <div
                      ...
                      style={{ width: `${f.weight}%`, background: ACCENT }}
                    />
                  </div>
                  <p className="text-[11px] mt-1" style={{ color: "#859397" }}>
                    {f.desc}
                  </p>
                </div>
              ))}
          ...
          <Section icon={Clock} title="Fil chronologique (sans algorithme)">
            Vous avez le droit à un fil non personnalisé. L'onglet{" "}
            <b>« Suivis »</b> de l'accueil affiche uniquement les publications
            des comptes que vous suivez, dans l'ordre chronologique, sans
          ...
          <Section icon={TrendingUp} title={t("trending")}>
            ...
            <b> dernières 24 heures</b>, pondérés par le nombre de publications
            et de likes. Elles se renouvellent automatiquement : aucun choix
            éditorial manuel.
          </Section>

          {/* Publicité */}
          <Section icon={Megaphone} title={t("ads")}>
            Les publicités affichées sont <b>non personnalisées</b> par défaut :
            elles ne reposent pas sur un profilage de votre comportement. Elles
            ne s'affichent qu'après votre consentement aux cookies.
          </Section>

          {/* Ce que nous n'utilisons pas */}
          <Section icon={ShieldCheck} title="Ce que nous n'utilisons pas">
            Aucun profilage fondé sur des données sensibles (opinions
            politiques, religion, orientation, santé). Vous pouvez désactiver
            les suggestions algorithmiques dans{" "}
            <b>Paramètres → Confidentialité</b>.
          </Section>
        </div>
