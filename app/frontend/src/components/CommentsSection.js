        ...
        prev.map((c) =>
          c.id === commentId
            ? {
                ...
                likesCount: c.likesCount + (res.data.liked ? 1 : -1),
              }
            : c,
        ),
      );
            ...
            <div key={comment.id} className="space-y-2">
              ...
              <div className="flex gap-2.5">
                ...
                <div className="flex-1 min-w-0">
                  <div
                    className="rounded-2xl rounded-tl-none px-3 py-2.5"
                    style={{ backgroundColor: C.high }}
                  >
                  ...
                  <div className="flex items-center gap-4 mt-1 ml-1">
                    ...
                    >
                      <span
                        ...
                        style={{
                          fontVariationSettings: comment.isLiked
                            ? "'FILL' 1"
                            : "'FILL' 0",
                        }}
                      >
                    ...
                    <button
                      ...
                      style={{
                        color: replyingTo === comment.id ? C.cyan : C.outline,
                      }}
                    >
                      {t("answer")}
                    </button>
                ...
                <div className="ml-10 flex gap-2 items-end">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="disabled:opacity-40 transition-colors hover:text-cyan-400"
                      style={{ color: C.outline }}
                    >
                      <span className="material-symbols-outlined text-sm">
                        send
                ...
                <div className="ml-10 space-y-2">
                  {comment.replies.map((reply) => (
                    <div key={reply.id} className="flex gap-2">
                      ...
                      />
                      <div
                        className="flex-1 rounded-2xl rounded-tl-none px-3 py-2"
                        style={{
