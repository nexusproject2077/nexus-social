...
const FireIcon = ({ size = 18 }) => (
  <Icon size={size}>
    <path d="M12 2c.4 2.2-.3 3.8-1.5 5.2C9 8.8 8 10.2 8 12.2c0 2.3 1.6 4 3.5 4.6-.2-.6-.3-1.2-.2-1.9.3-1.5 1.3-2.5 2.7-3.5 1.2 1.4 2 3 2 4.8 0 3.6-2.5 6-5.5 6S5 19.8 5 16.2C5 11.5 8.2 8.2 12 2z" fill="url(#nxFire)" />
    <path d="M12.2 14.5c.15 1 .8 1.7 1.8 2.1-.7.5-1.6.7-2.5.7-2 0-3.5-1.4-3.5-3.3 0-1.2.6-2.2 1.6-3 1.1 1 1.9 2.1 2.6 3.5z" fill="url(#nxFire2)" opacity=".9" />
    <defs>
      <linearGradient id="nxFire" x1="5" y1="2" x2="18" y2="22" gradientUnits="userSpaceOnUse">
        <stop stopColor="#fb923c" /><stop offset=".5" stopColor="#f97316" /><stop offset="1" stopColor="#ef4444" />
      </linearGradient>
      <linearGradient id="nxFire2" x1="8" y1="12" x2="14" y2="18" gradientUnits="userSpaceOnUse">
...
const ClapIcon = ({ size = 18 }) => (
  <Icon size={size}>
    <path d="M11.2 3.4c.5-.6 1.4-.6 1.9 0l.4.5c.3.4.2 1-.2 1.3L9.5 8.2l1.1-3.8c.1-.5-.1-1-.5-1.2l-.9-.5z" fill="#fbbf24" />
    <path d="M8.8 4.2c.4-.7 1.3-.8 1.9-.3l.3.3c.4.3.4.9.1 1.3L7.6 9.1l.7-3.5c.1-.5-.1-1-.5-1.2l-.9-.2z" fill="#f59e0b" />
    <path d="M6.2 8.5c-.4.3-.5.9-.2 1.3l3.8 5.2c.9 1.2 2.3 1.9 3.8 1.9h1.2c2.3 0 4.2-1.9 4.2-4.2v-.3c0-.7-.2-1.3-.6-1.9l-2.8-3.6c-.3-.4-.9-.5-1.3-.2l-.4.3c-.4.3-.5.9-.2 1.3l.9 1.2-3.5-4.8c-.3-.4-.9-.5-1.3-.2l-.4.3c-.4.3-.5.9-.2 1.3l2.2 3-2.8-3.8c-.3-.4-.9-.5-1.3-.2l-.4.3z" fill="url(#nxClap)" />
    <defs>
      <linearGradient id="nxClap" x1="6" y1="7" x2="18" y2="18" gradientUnits="userSpaceOnUse">
...
const ShockIcon = ({ size = 18 }) => (
  <Icon size={size}>
    ...
    <path d="M8.5 7.2c.6-.5 1.4-.5 2 0M13.5 7.2c.6-.5 1.4-.5 2 0" stroke="#0f172a" strokeWidth="1.2" strokeLinecap="round" />
    <defs>
      <linearGradient id="nxShock" x1="4" y1="3" x2="20" y2="21" gradientUnits="userSpaceOnUse">
        <stop stopColor="#fef08a" /><stop offset="1" stopColor="#facc15" />
      </linearGradient>
    </defs>
  </Icon>
);
...
const HeartIcon = ({ size = 18 }) => (
  <Icon size={size}>
    <path d="M12 20.4s-7.2-4.4-7.2-9.2A3.9 3.9 0 0 1 12 8.2a3.9 3.9 0 0 1 7.2 3c0 4.8-7.2 9.2-7.2 9.2z" fill="url(#nxHeart)" />
    <defs>
      <linearGradient id="nxHeart" x1="5" y1="6" x2="19" y2="20" gradientUnits="userSpaceOnUse">
...
const AngryIcon = ({ size = 18 }) => (
  <Icon size={size}>
    ...
    <path d="M7.5 9.2l3.2 1.2M16.5 9.2l-3.2 1.2" stroke="#0f172a" strokeWidth="1.5" strokeLinecap="round" />
    <circle cx="9" cy="11.5" r="1.2" fill="#0f172a" />
    <circle cx="15" cy="11.5" r="1.2" fill="#0f172a" />
    <path d="M9 16.2c1.2-1 4.8-1 6 0" stroke="#0f172a" strokeWidth="1.4" strokeLinecap="round" />
    <defs>
      <linearGradient id="nxAngry" x1="4" y1="3" x2="20" y2="21" gradientUnits="userSpaceOnUse">
...
const GoatIcon = ({ size = 18 }) => (
  <Icon size={size}>
    <path d="M7 11c0-2.5 1.5-4.5 3.2-5.2L9 3.5c.8.2 1.5.8 2 1.6.5-.8 1.2-1.4 2-1.6l-1.2 2.3C13.5 6.5 15 8.5 15 11c0 1.2-.3 2.2-.8 3H18v1.5h-3.2c-.7 1.5-2 2.5-3.8 2.5S8 17 7.2 15.5H4V14h3.8c-.5-.8-.8-1.8-.8-3z" fill="url(#nxGoat)" />
    <circle cx="10" cy="10.5" r="0.9" fill="#0f172a" />
    <circle cx="14" cy="10.5" r="0.9" fill="#0f172a" />
    <path d="M11.2 13h1.6" stroke="#0f172a" strokeWidth="1.2" strokeLinecap="round" />
    <defs>
      <linearGradient id="nxGoat" x1="4" y1="3" x2="18" y2="18" gradientUnits="userSpaceOnUse">
...
const BallIcon = ({ size = 16 }) => (
  <Icon size={size}>
    <circle cx="12" cy="12" r="9" fill="url(#nxBall)" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
    <path d="M12 3.5v17M3.5 12h17M6.2 6.2c2.5 1.2 5.1 1.2 7.6 0M6.2 17.8c2.5-1.2 5.1-1.2 7.6 0M6.2 6.2c-1.2 2.5-1.2 5.1 0 7.6M17.8 6.2c1.2 2.5 1.2 5.1 0 7.6" stroke="#0f172a" strokeWidth="1" opacity=".55" />
    <defs>
      <linearGradient id="nxBall" x1="4" y1="3" x2="20" y2="21" gradientUnits="userSpaceOnUse">
  ...
  return (
    <div className="mt-4 space-y-4 px-1 pb-2">
      ...
      <div className="flex items-center justify-between text-xs" style={{ color: "#9fb0c8" }}>
        ...
        {live && (
          <span className="flex items-center gap-1.5 font-bold tracking-wide" style={{ color: "#4ade80" }}>
      ...
      {/* Reactions — SVG only */}
      <div>
        <p className="text-xs font-bold mb-2 flex items-center gap-1.5" style={{ color: "#c5d0e6" }}>
          <BallIcon size={14} />
          ...
          {REACTIONS.map((r) => {
            ...
            return (
              <button
                ...
                style={{
                  background: active ? "rgba(34,211,238,0.14)" : "rgba(255,255,255,0.05)",
                  border: active ? "1px solid rgba(34,211,238,0.45)" : "1px solid rgba(255,255,255,0.06)",
                  boxShadow: active ? "0 0 12px rgba(34,211,238,0.15)" : "none",
                }}
              >
                <Ico size={18} />
                <span className="text-[11px] font-bold tabular-nums" style={{ color: active ? "#67e8f9" : "#a7b3cc" }}>
                  {reactions[r.id] || 0}
                </span>
              </button>
            );
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  border: vote === o.id ? "1px solid rgba(34,211,238,0.5)" : "1px solid rgba(255,255,255,0.06)",
                }}
              >
                <div
                  ...
                  style={{
                    ...
                    background: o.id === "draw" ? "#64748b" : "linear-gradient(90deg,#22d3ee,#3b82f6)",
                  }}
                />
      ...
      <div className="grid grid-cols-2 gap-2">
        <button type="button" onClick={shareToFeed}
        ...
        <button type="button" onClick={toggleGoalAlert}
          className="col-span-2 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-bold"
          style={{
            background: goalAlert ? "rgba(34,211,238,0.12)" : "rgba(255,255,255,0.06)",
            color: goalAlert ? "#67e8f9" : "#e2e8f0",
            border: goalAlert ? "1px solid rgba(34,211,238,0.4)" : "1px solid transparent",
          }}>
