...
export default function ProfilePage({ user, setUser }) {
  ...
  const fetchUserPosts = async () => {
    try {
      ...
      if (err.response?.status !== 403) toast.error(t("error_loading_posts"));
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleFollow = async () => {
    ...
    try {
      ...
      if (res.data.status === "pending")
        toast.success(t("follow_request_sent"));
      else {
        toast.success(t("followed_success"));
  ...
  const handlePostDelete = (id) => {
    ...
    setStats((p) => ({ ...p, posts: Math.max(0, p.posts - 1) }));
  };
  ...
  const canViewContent =
    isOwnProfile || !profile?.is_private || followStatus === "following";
  ...
  const FollowButton = () => {
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            style={{
              ...
              color: C.primary,
              border: `1px solid ${C.primaryContainer}33`,
            }}
    ...
    if (followStatus === "pending")
      return (
        ...
        >
          {followLoading ? spinner("#fbbf24") : <Clock size={14} />} Demande
          envoyée
        </button>
      );
      ...
      <Layout user={user} setUser={setUser}>
        ...
        >
          <div
            ...
            style={{ ...glass, border: `1px solid ${C.outlineVariant}22` }}
          >
            <div
    ...
    <Layout user={user} setUser={setUser} hideMobileHeader>
      ...
      <div className="relative w-full overflow-hidden" style={{ height: 290 }}>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #0a1628 0%, #0d1e3d 35%, #071525 65%, #0b1326 100%)",
          }}
        />
        {/* Ambient glows */}
        <div
          ...
          style={{
            ...
            left: "20%",
            background:
              "radial-gradient(circle, rgba(34,211,238,0.12), transparent)",
          }}
        />
        <div
          className="absolute rounded-full blur-3xl"
          style={{
            ...
            right: "25%",
            background:
              "radial-gradient(circle, rgba(59,130,246,0.10), transparent)",
          }}
        />
        {/* Fade to surface */}
        <div
          className="absolute inset-0"
          style={{
            background: `linear-gradient(to bottom, transparent 0%, ${C.surface}80 60%, ${C.surface} 100%)`,
            zIndex: 1,
          }}
        />
        ...
        {/* Profile overlay */}
        <div
          className="absolute bottom-0 left-0 w-full px-5 sm:px-8 pb-6"
          style={{ zIndex: 2 }}
        >
          <div className="flex flex-col sm:flex-row items-end gap-5 sm:gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative flex-shrink-0 group">
              <div
                className="absolute inset-0 rounded-full blur-2xl opacity-0 group-hover:opacity-30 transition-opacity"
              ...
              >
                {profile.profile_pic ? (
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${C.primaryContainer}, #3b82f6)`,
                      color: C.onPrimary,
              ...
              <div className="flex flex-wrap items-center gap-3 mb-2">
                <h1
                  ...
                  style={{
                    ...
                    textShadow: "0 0 28px rgba(34,211,238,0.38)",
                  }}
                >
                  {profile.username}
                </h1>
                    ...
                    try {
                      if (navigator.share)
                        await navigator.share({
                          title: `@${profile.username} sur Nexus`,
                          url,
                        });
                      else {
                ...
                {!isOwnProfile && profile.crypto_wallet && (
                  <button
                    ...
                    onClick={() => {
                      navigator.clipboard
                        ?.writeText(profile.crypto_wallet)
                        .then(
              ...
              {[
                ...
                return (
                  <button
                    ...
                    disabled={!clickable}
                    onClick={() =>
                      clickable && setFollowModal({ kind: s.kind })
                    }
                    className={`text-center px-5 py-3 rounded-2xl ${clickable ? "hover:brightness-125 transition-all cursor-pointer" : "cursor-default"}`}
                    style={{
                      ...glass,
                      border: `1px solid ${C.outlineVariant}18`,
                    }}
                  >
                    <span
                      className="block text-[10px] uppercase tracking-widest font-bold mb-0.5"
                      style={{ color: C.outline }}
                    >
                      {s.label}
                    </span>
      ...
      <div
        ...
        style={{
          ...
          borderTop: `1px solid ${C.outlineVariant}18`,
          borderBottom: `1px solid ${C.outlineVariant}18`,
        }}
      >
            ...
            return (
              ...
              >
                <span
                  ...
                  style={{
                    color: active ? C.primaryContainer : C.outline,
                ...
                {active && (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: `0 0 10px ${C.primaryContainer}cc`,
                    }}
                  />
                )}
              </button>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 pb-28 md:pb-8">
        ...
        {!canViewContent ? (
          <div
            ...
            style={{
              background: `${C.surfaceContainer}80`,
              border: `1px solid ${C.outlineVariant}18`,
            }}
          >
            <svg
            ...
            >
              <defs>
                <linearGradient id="nexusLockGrad" x1="0" y1="0" x2="1" y2="1">
                  <stop
                    offset="0%"
                    stopColor={C.primaryContainer || "#22d3ee"}
                  />
              ...
              <circle
                ...
                cy="48"
                r="46"
                fill={`${C.primaryContainer || "#22d3ee"}14`}
              />
              {/* anse du cadenas */}
              <path
                d="M32 44 V34 a16 16 0 0 1 32 0 V44"
                stroke="url(#nexusLockGrad)"
                strokeWidth="6"
                strokeLinecap="round"
                fill="none"
              />
                ...
                <div className="space-y-4">
                  {reposts.map((post) => (
                    <PostCard
                      ...
                      onUpdate={handlePostUpdate}
                      onDelete={(id) => {
                        setReposts((r) => r.filter((p) => p.id !== id));
                        handlePostDelete(id);
                      }}
                    />
                  ))}
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-white">
                Envoyer un pourboire à @{profile.username}
              </h3>
            </div>
            ...
            <p className="text-[11px] text-center" style={{ color: C.outline }}>
              Paiement sécurisé via Stripe. Le créateur reçoit le montant après
              commission de la plateforme.
            </p>
            <button
              onClick={() => setShowTip(false)}
              className="w-full mt-3 py-2.5 rounded-xl text-sm font-bold"
              style={{ background: "#222a3d", color: C.onVariant }}
            >
              {t("cancel")}
            </button>
          </div>
      ...
      {followModal && (
        <FollowListModal
          ...
          title={
            followModal.kind === "followers" ? t("followers") : t("following")
          }
