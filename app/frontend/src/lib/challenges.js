...
const ROTATION = [
  { tag: "NexusClip", title_key: "challenge.weekly_clip", emoji: "🎬" },
  { tag: "NexusUCL", title_key: "challenge.ucl", emoji: "⚽" },
  { tag: "NexusSkill", title_key: "challenge.skill", emoji: "🔥" },
  { tag: "NexusLaugh", title_key: "challenge.laugh", emoji: "😂" },
];
