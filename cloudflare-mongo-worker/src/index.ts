...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    try {
      ...
      if (url.pathname === ["/api/analytics/stats","/api/analytics/me/stats"].includes(url.pathname) && request.method === "GET") {
      ...
      if (url.pathname === ["/api/analytics/trends","/api/analytics/me/trends"].includes(url.pathname) && request.method === "GET") {
